        ...
        <div style={{ background: colors.bgSecondary, border: `1px solid ${colors.border}`, borderRadius: "12px", padding: "40px" }}>
          {activeTab === "theory" && (
            <div>
              ...
              <p style={{ color: colors.textSecondary, lineHeight: "1.8", marginBottom: "20px" }}>
                LinkedIn est le réseau professionnel avec <strong>900+ millions d'utilisateurs</strong>. Les utilisateurs partagent volontairement carrière, compétences, éducation, certifications, réseau professionnel.
              </p>
              ...
              <div style={{ background: colors.bgPrimary, padding: "20px", borderRadius: "8px", marginBottom: "15px" }}>
                ...
                <p style={{ color: colors.textSecondary, lineHeight: "1.6", margin: 0 }}>Nom, photo, poste, entreprise, localisation, historique complet, formation, compétences, certifications, langues, recommandations.</p>
              </div>
              <div style={{ background: colors.bgPrimary, padding: "20px", borderRadius: "8px", marginBottom: "15px" }}>
                <h4 style={{ color: colors.accent, marginBottom: "10px" }}>Page entreprise</h4>
                <p style={{ color: colors.textSecondary, lineHeight: "1.6", margin: 0 }}>Effectifs, répartition géographique, croissance, postes ouverts, employés par département, nouveaux arrivants, départs.</p>
              </div>
            </div>
          )}
          ...
          {activeTab === "tools" && (
            <div>
              ...
              <p style={{ color: colors.textSecondary, marginBottom: "10px" }}><strong>Sales Navigator :</strong> Outil officiel LinkedIn (~80€/mois)</p>
              <p style={{ color: colors.textSecondary, marginBottom: "10px" }}><strong>CrossLinked :</strong> Scraper Python pour lister employés</p>
          ...
          {activeTab === "exercises" && (
            <div>
              ...
              <div style={{ background: colors.bgPrimary, padding: "25px", borderRadius: "12px", marginBottom: "20px" }}>
                ...
                <p style={{ color: colors.textSecondary, marginBottom: "15px" }}><strong>Objectif :</strong> Identifier responsables sécurité d'une entreprise CAC40</p>
                <ol style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px" }}>
                  <li>Rechercher company:"NomEntreprise" title:"CISO"</li>
                  <li>Noter : nom, poste, ancienneté, localisation</li>
                  <li>Analyser parcours : formations cyber, certifications</li>
                </ol>
              </div>
              <div style={{ background: colors.bgPrimary, padding: "25px", borderRadius: "12px", marginBottom: "20px" }}>
                <h3 style={{ color: colors.accent, fontSize: "1.3rem", marginBottom: "15px" }}>Exercice 2 : Analyse turnover</h3>
                <p style={{ color: colors.textSecondary, marginBottom: "15px" }}><strong>Objectif :</strong> Détecter départs massifs</p>
                <ol style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px" }}>
                  <li>Chercher anciens employés startup tech</li>
                  <li>Filtrer départs 6 derniers mois</li>
                  <li>Compter départs par département</li>
                </ol>
              </div>
              <div style={{ background: colors.bgPrimary, padding: "25px", borderRadius: "12px" }}>
                ...
                <p style={{ color: colors.textSecondary, marginBottom: "15px" }}><strong>Objectif :</strong> Identifier technologies utilisées</p>
                <ol style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px" }}>
                  <li>Lister développeurs entreprise cible</li>
                  <li>Analyser compétences : Python, AWS, Kubernetes...</li>
                  <li>Croiser avec offres d'emploi</li>
                </ol>
              </div>
            </div>
          )}

...
export default function DiscordModule() {
  ...
  const quizQuestions = [
    ...
    { id: 3, question: "Les serveurs Discord sont-ils indexés par Google ?", options: ["Non, pas par défaut", "Oui tous", "Seulement les publics", "Avec autorisation"], correct: 0 },
    { id: 4, question: "Quel site permet de trouver des serveurs Discord publics ?", options: ["disboard.org", "discordfinder.com", "serverlist.io", "discorddb.com"], correct: 0 },
    { id: 5, question: "Peut-on récupérer des messages supprimés sur Discord ?", options: ["Non, sauf si loggés par un bot", "Oui toujours", "Avec Nitro", "Via support Discord"], correct: 0 }
  ];
        ...
        <div style={{ background: colors.bgSecondary, border: `1px solid ${colors.border}`, borderRadius: "12px", padding: "40px" }}>
          {activeTab === "theory" && (
            <div>
              ...
              <p style={{ color: colors.textSecondary, lineHeight: "1.8", marginBottom: "20px" }}>
                Discord est une plateforme de communication avec <strong>150+ millions d'utilisateurs actifs</strong>. Initialement créée pour les gamers, elle héberge maintenant des communautés crypto, NFT, hacking, activisme politique et plus. Les serveurs Discord sont souvent fermés mais des annuaires publics existent.
              </p>
              ...
              <ul style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px" }}>
                <li><strong>Serveurs (Guilds) :</strong> Communautés avec Server ID unique (18 chiffres)</li>
                <li><strong>Canaux :</strong> Textuels ou vocaux, avec Channel ID</li>
                <li><strong>Utilisateurs :</strong> User ID + discriminateur (#1234)</li>
              </ul>
              <h3 style={{ color: colors.accent, fontSize: "1.5rem", marginBottom: "15px", marginTop: "25px" }}>💡 Cas d'usage OSINT</h3>
              <ul style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px" }}>
                <li>Surveillance de communautés crypto/NFT pour scams</li>
                <li>Monitoring de groupes extrémistes</li>
                <li>Investigation de serveurs de gaming/cheating</li>
                <li>Analyse de serveurs ransomware</li>
              </ul>
            </div>
          )}
          ...
          {activeTab === "tools" && (
            <div>
              ...
              <p style={{ color: colors.textSecondary, marginBottom: "8px" }}>• <strong>disboard.org</strong> - 800K+ serveurs publics</p>
              <p style={{ color: colors.textSecondary, marginBottom: "8px" }}>• <strong>discord.me</strong> - Annuaire avec catégories</p>
              <p style={{ color: colors.textSecondary, marginBottom: "20px" }}>• <strong>top.gg</strong> - Serveurs et bots</p>
              ...
              <div style={{ background: colors.bgPrimary, padding: "15px", borderRadius: "8px", marginBottom: "20px", fontFamily: "monospace", fontSize: "0.9rem" }}>
                <div style={{ color: colors.textSecondary, marginBottom: "8px" }}><strong style={{ color: colors.accent }}>site:discord.gg "OSINT"</strong></div>
                <div style={{ color: colors.textSecondary }}><strong style={{ color: colors.accent }}>site:discord.com/invite</strong></div>
              </div>
              <h3 style={{ color: colors.accent, fontSize: "1.5rem", marginBottom: "15px" }}>Lookup d'IDs</h3>
              <p style={{ color: colors.textSecondary, marginBottom: "8px" }}>• <strong>discord.id</strong> - Info sur User/Server ID</p>
              <p style={{ color: colors.textSecondary }}>• <strong>Discord Developer Mode</strong> - Copier les IDs directement</p>
              <h3 style={{ color: colors.accent, fontSize: "1.5rem", marginBottom: "15px", marginTop: "25px" }}>Bots de logging</h3>
              <div style={{ background: colors.bgPrimary, padding: "15px", borderRadius: "8px", fontFamily: "monospace", fontSize: "0.85rem" }}>
                <div style={{ color: colors.textSecondary }}>pip install discord.py</div>
                <div style={{ color: colors.textSecondary, marginTop: "10px" }}>import discord</div>
              </div>
              <p style={{ color: "#ef4444", marginTop: "15px", fontWeight: "600" }}>⚠️ Logging sans consentement viole les CGU Discord !</p>
            </div>
          )}
          ...
          {activeTab === "exercises" && (
            <div>
              ...
              <div style={{ background: colors.bgPrimary, padding: "25px", borderRadius: "12px", marginBottom: "20px" }}>
                <h3 style={{ color: colors.accent, fontSize: "1.3rem", marginBottom: "15px" }}>Exercice : Serveur crypto suspect</h3>
                <p style={{ color: colors.textSecondary }}>Trouvez un serveur Discord lié à un projet NFT. Analysez : nombre de membres, date de création, canaux actifs, red flags (promesses irréalistes, pas de roadmap, etc.).</p>
              </div>
            </div>
          )}

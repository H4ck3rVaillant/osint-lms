...
export default function CasVerificationMedia() {
  ...
  const BADGE_KEY = "badge_case_media";
  const QUIZ_ANSWERS_KEY = "quiz_case_media_answers";
  const QUIZ_COMPLETED_KEY = "quiz_case_media_completed";
  ...
  const handleQuizSubmit = () => {
    ...
    if (score >= 2) {
      ...
      unlockBadge(BADGE_KEY, "Vérification de Médias");
    }
  };
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <p style={{ fontSize: "1.1rem", color: colors.textSecondary, maxWidth: "700px", margin: "0 auto" }}>
            Détection de manipulations et désinformation
          </p>
        ...
        <div style={{ background: colors.bgSecondary, borderRadius: "16px", padding: "40px", boxShadow: "0 4px 20px rgba(0,0,0,0.3)" }}>
          {activeTab === "theory" && (
            <div>
              ...
              <p style={{ color: colors.textSecondary, fontSize: "1.05rem", lineHeight: "1.8", marginBottom: "25px" }}>
                La vidéo correspond à un <strong style={{ color: colors.accent }}>exercice militaire filmé en 2016</strong>, réutilisé

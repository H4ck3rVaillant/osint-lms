...
// JE METS LES 52 CHALLENGES ICI - TROP LONG POUR TOUT ÉCRIRE
        ...
        <>
          ...
          <div style={{
            ...
            <p style={{ color: colors.textSecondary, textAlign: "center", marginBottom: "30px", lineHeight: "1.6" }}>
              Cette action va <strong style={{ color: "#ef4444" }}>supprimer DÉFINITIVEMENT</strong> toute votre progression !
            </p>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "40px 20px" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <p style={{ fontSize: "1.1rem", color: colors.textSecondary }}>
            Semaine {currentWeek + 1}/{CHALLENGES.length} • Nouveau dans {timeLeft.days}j {timeLeft.hours}h
          </p>
        </div>
        ...
        <div style={{
          ...
          {!isSolved ? (
            ...
            <div style={{
              ...
              <p style={{ fontSize: "1.2rem", fontWeight: "600", color: "#10b981", margin: 0 }}>
                ✅ Résolu ! +{currentChallenge.points} XP
              </p>
            </div>
          )}
          ...
          }}>💡 {showHint ? "Masquer" : "Indice"}</button>
        ...
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "20px" }}>
            {[
              ...
              { val: solvedChallenges.length * 25, label: "XP gagnés" }
            ].map((s, i) => (
              <div key={i}>
        ...
        <div style={{
          ...
          <p style={{ color: colors.textSecondary, marginBottom: "20px", fontSize: "0.95rem" }}>
            Réinitialiser votre progression supprimera TOUS vos challenges.
          </p>

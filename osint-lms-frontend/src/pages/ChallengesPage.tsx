...
export default function ChallengesPage() {
  ...
  return (
    <div style={{
      ...
      {/* MODAL RESET STYLE TRYHACKME VERT */}
      {showResetModal && (
        <>
          ...
          <div style={{
            ...
            <p style={{ color: "#9ca3af", textAlign: "center", marginBottom: "30px", lineHeight: "1.6" }}>
              Cette action va <strong style={{ color: "#00ff9c" }}>supprimer DÉFINITIVEMENT</strong> toute votre progression !
            </p>
      ...
      <div style={{
        ...
        {/* Bouton Réinitialiser - Style TryHackMe VERT */}
        <div style={{
          background: "#0b0f1a",

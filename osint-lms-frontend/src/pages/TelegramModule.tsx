    ...
    <div style={{ minHeight: "100vh", background: colors.bgPrimary, paddingTop: "80px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <p style={{ fontSize: "1.1rem", color: colors.textSecondary, maxWidth: "700px", margin: "0 auto" }}>Investigation canaux, groupes et communautés Telegram</p>
        ...
        <div style={{ background: colors.bgSecondary, border: `1px solid ${colors.border}`, borderRadius: "12px", padding: "40px" }}>
          {activeTab === "theory" && (
            <div>
              ...
              <p style={{ color: colors.textSecondary, lineHeight: "1.8", marginBottom: "20px" }}>
                Telegram est une messagerie chiffrée avec <strong>700+ millions d'utilisateurs</strong>. De nombreux canaux et groupes sont publics et indexables. Populaire chez hackers, activistes, crypto-traders, whistleblowers.
              </p>
              ...
              <ul style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px", marginBottom: "25px" }}>
                <li><strong>Surveillance leaks :</strong> Canaux partageant databases volées, credentials</li>
              ...
              <h3 style={{ color: colors.accent, fontSize: "1.5rem", marginBottom: "15px" }}>📊 Types contenus</h3>
              <div style={{ background: colors.bgPrimary, padding: "20px", borderRadius: "8px", marginBottom: "15px" }}>
                ...
                <p style={{ color: colors.textSecondary, lineHeight: "1.6", margin: 0 }}>Diffusion unidirectionnelle, membres illimités, historique complet accessible. URL : t.me/nomcanal</p>
              </div>
              <div style={{ background: colors.bgPrimary, padding: "20px", borderRadius: "8px" }}>
                ...
                <p style={{ color: colors.textSecondary, lineHeight: "1.6", margin: 0 }}>Discussions bidirectionnelles, max 200K membres. URL : t.me/joinchat/...</p>
              </div>
            </div>
          )}
          ...
          {activeTab === "tools" && (
            <div>
              ...
              <p style={{ color: colors.textSecondary, marginBottom: "15px" }}>Dans Telegram app : recherche globale par @username, nom canal, mots-clés</p>
              ...
              <p style={{ color: colors.textSecondary, marginBottom: "10px" }}><strong>tgstat.com :</strong> Analytics canaux, stats abonnés</p>
              <p style={{ color: colors.textSecondary, marginBottom: "10px" }}><strong>telemetr.io :</strong> Statistiques détaillées</p>
              <h3 style={{ color: colors.accent, fontSize: "1.5rem", marginBottom: "15px" }}>Scraping : Telethon</h3>
              <div style={{ background: colors.bgPrimary, padding: "15px", borderRadius: "8px", fontFamily: "monospace", fontSize: "0.85rem" }}>
                ...
                <div style={{ color: colors.textSecondary }}>messages = await client.get_messages('channel', limit=100)</div>
              </div>
            </div>
          )}
          ...
          {activeTab === "exercises" && (
            <div>
              ...
              <div style={{ background: colors.bgPrimary, padding: "25px", borderRadius: "12px", marginBottom: "20px" }}>
                ...
                <p style={{ color: colors.textSecondary, marginBottom: "15px" }}><strong>Objectif :</strong> Identifier canaux partageant databases leakées</p>
                <ol style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px" }}>
                  <li>Google : site:t.me "leaked database"</li>
                  <li>Noter : nom, abonnés, date création</li>
                  <li>Analyser types données partagées</li>
                </ol>
              </div>
              <div style={{ background: colors.bgPrimary, padding: "25px", borderRadius: "12px", marginBottom: "20px" }}>
                <h3 style={{ color: colors.accent, fontSize: "1.3rem", marginBottom: "15px" }}>Exercice 2 : Monitoring ransomware</h3>
                <p style={{ color: colors.textSecondary, marginBottom: "15px" }}><strong>Objectif :</strong> Surveiller canaux groupes ransomware</p>
                <ol style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px" }}>
                  <li>Rechercher canaux ransomware connus</li>
                  <li>Observer victimes publiées, deadlines</li>
                  <li>Croiser avec intelligence feeds</li>
                </ol>
              </div>
              <div style={{ background: colors.bgPrimary, padding: "25px", borderRadius: "12px" }}>
                <h3 style={{ color: colors.accent, fontSize: "1.3rem", marginBottom: "15px" }}>Exercice 3 : Scraping Telethon</h3>
                <p style={{ color: colors.textSecondary, marginBottom: "15px" }}><strong>Objectif :</strong> Extraire historique canal public</p>
                <ol style={{ color: colors.textSecondary, lineHeight: "1.8", marginLeft: "20px" }}>
                  <li>Créer app Telegram : my.telegram.org</li>
                  <li>Obtenir api_id et api_hash</li>
                  <li>Script Telethon pour messages</li>
                </ol>
              </div>
            </div>
          )}

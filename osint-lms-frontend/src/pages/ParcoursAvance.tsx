  ...
  return (
    <main style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}>
      <h1 style={{ color: "#00ff9c", fontSize: "2rem", marginBottom: "10px" }}>
        Parcours AvancÃ© OSINT
      </h1>
      <p style={{ color: "#9ca3af", marginBottom: "30px", fontSize: "1.1rem" }}>
        Niveau expert : renseignement stratÃ©gique, threat intelligence et investigations professionnelles de haute volÃ©e.
      </p>
      ...
      <section style={{ 
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: "12px" }}>
            <h2 style={titleStyle}>Module 1: Renseignement StratÃ©gique</h2>
            <span style={{ color: introDone ? "#00ff9c" : "#6b7280", fontSize: "1.5rem" }}>
              {introDone ? "â" : "â"}
            </span>
          </div>
          <p style={textStyle}>
            Passez de l'analyse tactique au renseignement stratÃ©gique pour Ã©clairer les dÃ©cisions de haut niveau.
          </p>
          <ul style={{ ...textStyle, paddingLeft: "20px", margin: "12px 0" }}>
            <li>Intelligence stratÃ©gique et environnement informationnel</li>
            <li>DÃ©tection de dÃ©sinformation et opÃ©rations d'influence</li>
            <li>Signaux gÃ©opolitiques et threat intelligence</li>
          </ul>
          <p style={{ 
            ...textStyle, 
        ...
        {introDone ? (
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: "12px" }}>
              <h2 style={titleStyle}>Module 2: MÃ©thodologie Experte</h2>
              <span style={{ color: methodoDone ? "#00ff9c" : "#6b7280", fontSize: "1.5rem" }}>
                {methodoDone ? "â" : "â"}
              </span>
            </div>
            <p style={textStyle}>
              MaÃ®trisez les mÃ©thodologies analytiques avancÃ©es utilisÃ©es par les agences de renseignement.
            </p>
            <ul style={{ ...textStyle, paddingLeft: "20px", margin: "12px 0" }}>
              <li>Cycle de renseignement professionnel et ACH</li>
              <li>Fusion multi-INT et modÃ¨le Admiralty</li>
              <li>Production de livrables exÃ©cutifs et briefings</li>
            </ul>
            <p style={{ 
              ...textStyle, 
        ...
        {methodoDone ? (
          ...
          >
            ...
            <p style={textStyle}>
              Automatisez vos investigations avec des APIs, Python et des bases de donnÃ©es graphes avancÃ©es.
            </p>
            <ul style={{ ...textStyle, paddingLeft: "20px", margin: "12px 0" }}>
              <li>APIs OSINT : Shodan, VirusTotal, GitHub</li>
              <li>Python avancÃ© et frameworks d'automatisation</li>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ color: "#00ff9c", marginBottom: "15px", fontSize: "1.5rem" }}>
              RÃ©initialiser le parcours AvancÃ© ?
            </h3>
            <p style={{ color: "#9ca3af", marginBottom: "30px", lineHeight: "1.6" }}>
              Tous vos badges du parcours AvancÃ© seront verrouillÃ©s et vous devrez complÃ©ter les modules Ã  nouveau. 

        ...
        <div>
          ...
          <div style={{
            ...
            <p style={{ color: "#e5e7eb", lineHeight: "1.9", fontSize: "1.05rem" }}>
              En ingérant des <strong style={{ color: "#00ff9c" }}>Software Bill of Materials (SBOM)</strong>, Dependency-Track corrèle
      ...
      {activeTab === "sbom" && (
        <div>
          <div style={{
            ...
            <p style={{ color: "#e5e7eb", lineHeight: "1.9", fontSize: "1.05rem" }}>
              Un <strong style={{ color: "#00ff9c" }}>SBOM</strong> est une liste exhaustive et formalisée de tous les composants,
        ...
        <div>
          ...
          <div style={{ display: "grid", gap: "25px" }}>
            ...
            <div style={{
              ...
              <h3 style={{ color: "#00ff9c", marginBottom: "15px" }}>📋 Prérequis</h3>
            ...
            <div style={{
              ...
              <h3 style={{ color: "#00ff9c", marginBottom: "15px" }}>🐳 Démarrage rapide (Docker Compose)</h3>
...
# ⚠️ CHANGEZ LE MOT DE PASSE IMMÉDIATEMENT`} id="docker-compose" />
            ...
            <div style={{
              ...
              <h3 style={{ color: "#00ff9c", marginBottom: "15px" }}>📄 docker-compose.yml (production)</h3>
...
volumes:
  ...
  postgres-data:`} id="compose-yml" />
            ...
            <div style={{
              ...
              <h3 style={{ color: "#00ff9c", marginBottom: "15px" }}>📤 Upload SBOM via API</h3>
